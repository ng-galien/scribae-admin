...
function toggleFullScreen(editor) {
    ...
    CodeMirror.signal(cm, "fullscreen", true);
	} else {
    wrap.previousSibling.className = wrap.previousSibling.className.replace(/\s*fullscreen\b/, "");
    CodeMirror.signal(cm, "fullscreen", false);
	}
...
function toggleSideBySide(editor) {
    ...
    CodeMirror.signal(cm, "sidebyside", false);
	} else {

    CodeMirror.signal(cm, "sidebyside", true);
...
function togglePreview(editor) {
    ...
    CodeMirror.signal(cm, "preview", false);
	} else {
      ...
      CodeMirror.signal(cm, "preview", true);
		}, 1);
		if(toolbar) {
