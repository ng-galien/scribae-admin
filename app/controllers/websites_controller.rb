...
class WebsitesController < ApplicationController
  ...
  def create
    ...
    sample @website
    @website.save!
    @website.articles.each do |article|
  ...
  private
    ...
    def sample website
      ...
      home_title             = t 'website.default.home_title'
      home_icon              = t 'website.default.home_icon'
      ...
      modules.each_with_index do |comp_name, index|
        component = Component.new do |comp| 
          comp.name = comp_name
          comp.show = "website.default.components.#{comp_name}.show"
          comp.pos = index + 1
